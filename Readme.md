...
>
> **Môn học:** PRF192/193 - Cơ sở Lập trình C/C++  
> **Giao diện:** CUI (Console User Interface)  
> **Đặc tính nâng cao:** Lưu trữ dữ liệu vĩnh viễn (File Handling)
...
[Ctrl + Shift + V] : OPEN README.MD
[Shift + Alt + F] : FIXING MARKDOWN

💡RUN PROJECT : 
[1] g++ System/main.cpp "QUẢN LÝ KHO/Material.cpp" "NHÂN SỰ & BÀN TRÀ/RoomService.cpp" "ĐƠN HÀNG & TƯ VẤN/Order.cpp" -o main]
[2] [./main.exe]
